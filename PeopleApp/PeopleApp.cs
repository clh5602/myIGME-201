                    ...
                    case "list":
                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            if (thisPerson.GetType() == typeof(Student))
                            {
                                ...
                                {
                                    string result = "\t ";
                                    Course thisCourse = courses.sortedList[courseName];

                                    result += courseName + " - ";
                                    result += thisCourse.description + " ";
                                    foreach (DayOfWeek day in thisCourse.schedule.daysOfWeek)
                                    {
                                        result += day.ToString();
                                        result += " ";
                                    }
                                    result += $"{thisCourse.schedule.startTime:hh:mmtt}" + " " + $"{thisCourse.schedule.endTime:hh:mmtt}";
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                do
                {
                    ...
                    {
                        thisStudent.courseCodes.Add(userInput);
                    }
